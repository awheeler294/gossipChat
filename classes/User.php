...
Class User {
	...
	public static function getUsers() {
        ...
        // error_log('[mtapt][User][getUsers]::$userResults ' . print_r($userResults, true));

        $users = array();
        foreach ($userResults as $user) {
        	// error_log('[mtapt][User][getUsers]::$user ' . print_r($user, true));
        	$users[] = new User($user['id'], $user['username']);
        }
        // error_log('[mtapt][User][getUsers]::$users ' . print_r($users, true));
		return $users;
	}
	...
	public static function getCurrentUser() {
		...
		// error_log('[mtapt][User][getUsers]::session_status ' . print_r(session_status(), true));
		// error_log('[mtapt][User][getUsers]::$_SESSION ' . print_r($_SESSION, true));
